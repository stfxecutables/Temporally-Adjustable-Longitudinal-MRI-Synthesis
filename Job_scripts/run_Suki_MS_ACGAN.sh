...
TASK=LongitudinalSynthesisACGAN   # LongitudinalSynthesisGAN LongitudinalSynthesis LongitudinalSynthesisACGAN
...
tensorboard --logdir="$LOG_DIR" --host 0.0.0.0 & python3 /home/jueqi/projects/def-jlevman/jueqi/MS/4/project/main.py \
       --use_tanh \
       --gpus=$GPUS \
       --loss="$LOSS" \
       --optim=$OPTIM \
